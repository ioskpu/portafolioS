...
//
import {
  SiTypescript, SiPostman, SiReact, SiCsharp, SiJavascript, SiSequelize, SiPhp, SiRedux, SiSqlite,
  SiNestjs, SiPostgresql, SiSocketdotio, SiDocker, SiKubernetes, SiDotnet, SiVercel,SiLaravel,
  SiCucumber, SiPrisma, SiEslint, SiBitbucket, SiExpress, SiHtml5, SiCss3, SiJira, SiFastify, SiSwagger
} from "react-icons/si";
