...
// import { AspectRatio, VStack, Text, Badge, useColorModeValue, UnorderedList, ListItem } from "@chakra-ui/react";
...
//     devStack: [
//       CiLibs.Laravel.icon,Libs.JavaScript.icon, SecondaryLibs.MySQL.icon,
